...
#日本語化するための設定を追記
sudo mkdir /mnt/system/system/ok
sudo chmod -R 777 /mnt/system/system/ok
sed -e /'ro.product.locale/d' /mnt/system/system/build.prop > /mnt/system/system/ok/build.prop
sudo rm /mnt/system/system/build.prop
sudo mv /mnt/system/system/ok/build.prop /mnt/system/system/build.prop
sudo rm -r /mnt/system/system/ok
